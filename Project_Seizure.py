...
#multiple_oscillator(100,2.4,[0,2*np.pi],[0.1,3],(0,50))
#===========================================================================================

def multiple_nodes(P,N,C,omega_range,K_range,y0_range,t):
...
multiple_nodes(3,10,3.3,[3.0,5.5],[4.5,3.6],[0,2*np.pi],(0,30))
